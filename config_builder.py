...
def build_config_metadata(
    ...
    export_directory = os.path.join(output_directory, "outputs", "domains", domain)
    log_directory = os.path.join(output_directory, "logs", "domains", domain)

    # Create a subdirectory for each batch size
    if global_batch_size is not ALL:
        export_directory = os.path.join(export_directory, experiment_id)
        log_directory = os.path.join(log_directory, experiment_id)
